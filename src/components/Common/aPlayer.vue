        ...
        return [
          {
            title: '所以你睡了没',
            artist: '沙一汀',
            url: require('../../assets/mp3/sleepOrNot.mp3'),
            pic: require('../../assets/img/sleepornot.jpg')
          },
          {
            title: 'love story',
            artist: 'Taylor Swift',
            url: require('../../assets/mp3/lovestory.mp3'),
            pic: require('../../assets/img/lovestory.png')
          },
          {
            title: 'confetti',
            artist: 'Rich Brain',
            url: require('../../assets/mp3/confetti.mp3'),
            pic: require('../../assets/img/confetti.jpg')
          },
          {
            title: 'lemon', //歌曲名称
            artist: '米津玄师', //演唱者
            // lrc: require("../../assets/mp3/Lemon.lrc"), //LRC 歌词或者歌词文件的 URL
            pic: require("../../assets/img/lemon.jpg"), //封面图片 URL
